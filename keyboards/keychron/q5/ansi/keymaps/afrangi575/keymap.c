...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_100(
        KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_MPLY,  KC_F10,   KC_F11,     KC_F12,   KC_F13,   _______,  KC_DEL,   KC_HOME,  KC_END,   _______,
    ...
    [MAC_FN] = LAYOUT_ansi_100(
        _______,  _______,  _______,  _______,  _______,  _______,  KC_F6,    KC_F7,    KC_F8,    KC_F9,    _______,  _______,    _______,   _______,  _______,  _______,  _______,  _______,  RGB_TOG,
